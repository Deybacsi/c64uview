...
The project is a fork of [Dusted's U64view](https://github.com/dusteddk/u64view/) to have a working linux streamer for C64U too. 
...
The best way is to start with `-I` because this will leave the stream on the C64U as it is was originally. Then you can press `S` key to start or stop the stream.
```
